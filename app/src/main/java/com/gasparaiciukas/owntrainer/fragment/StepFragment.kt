...
import com.gasparaiciukas.owntrainer.databinding.FragmentStepBinding
...
class StepFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Set up intent
        serviceIntent = Intent(requireContext(), StepCounterService::class.java)
    ...
    private fun saveSteps() {
        ...
        val sharedPreferences = requireActivity().getSharedPreferences("pedometer", AppCompatActivity.MODE_PRIVATE)
...
//        }
    ...
    private fun onStartButtonClicked() {
        ...
        requireActivity().registerReceiver(broadcastReceiver, IntentFilter(StepCounterService.BROADCAST_PEDOMETER))
        binding.btnStart.setText(R.string.stop)
