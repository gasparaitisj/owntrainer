...
class DiaryFragment : Fragment() {
    ...
    private fun initNavigation() {
        binding.cardNavigation.tvDayOfWeek.text = DateFormatter.dayOfWeekToString(viewModel.currentDay.dayOfWeek.value)
        binding.cardNavigation.tvMonthOfYear.text = DateFormatter.monthOfYearToString(viewModel.currentDay.monthValue)
